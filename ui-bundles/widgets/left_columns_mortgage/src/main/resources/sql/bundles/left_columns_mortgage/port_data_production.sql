INSERT INTO widgetcatalog (code, titles, parameters, plugincode, parenttypecode, defaultconfig, locked, maingroup) VALUES ('left_columns_mortgage', '<?xml version="1.0" encoding="UTF-8"?>
<properties>
    <property key="en">left_columns_mortgage</property>
    <property key="it">left_columns_mortgage </property>
</properties>', NULL, NULL, NULL, NULL, 1, NULL);

INSERT INTO guifragment (code, widgettypecode, plugincode, gui, defaultgui, locked) VALUES ('left_columns_mortgage', 'left_columns_mortgage', NULL, NULL, '<#assign wp=JspTaglibs["/aps-core"]>
